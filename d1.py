...
def data_entry1(x1,x2,x3):
    sqlcommand = 'insert into gelnome_scores values('+str(x1)+','+str(x2)+','+str(x3)+');'
    queryResult = runSqlQuery(sqlcommand)        
...
def data_entry5(x1,x2,x3):
    sqlcommand = 'insert into rating values('+str(x1)+','+str(x2)+','+str(x3)+');'#    sqlcommand = 'insert into genome_scores values('+chr(x1+48)+','+chr(x2+48)+','+chr(x3+48)+');'
    queryResult = runSqlQuery(sqlcommand)        
