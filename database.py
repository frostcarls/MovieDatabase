...
sqlcommand = '@create_table1.sql'
queryResult = runSqlQuery(sqlcommand)
print(*queryResult, sep = '\n')

sqlcommand = '@create_table2.sql'
queryResult = runSqlQuery(sqlcommand)
print(*queryResult, sep = '\n')

sqlcommand = '@create_table3.sql'
queryResult = runSqlQuery(sqlcommand)
print(*queryResult, sep = '\n')

sqlcommand = '@create_table4.sql'
queryResult = runSqlQuery(sqlcommand)
print(*queryResult, sep = '\n')

sqlcommand = '@create_table5.sql'
queryResult = runSqlQuery(sqlcommand)
print(*queryResult, sep = '\n')

sqlcommand = '@create_table6.sql'
queryResult = runSqlQuery(sqlcommand)
print(*queryResult, sep = '\n')
